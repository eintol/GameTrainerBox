...
// 版本 1.0.15690 (Unity IL2CPP, metadata v31), 2026-09-15 更新后 Steam buildid 25269320
...
export const survivalLogProfile: AttrDictProfile = {
  ...
  // 2026-09-15 定位 (buildid 25269320): 0x53b2190 (旧 1.0.15704 为 0x538bf00; 本次更新 Attr 字段偏移
